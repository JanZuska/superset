...
> = {
  ...
  [t('Week-to-Date')]: [moment().startOf('week'), moment()],
  [t('Month-to-Date')]: [moment().startOf('month'), moment()],
  [t('Quarter-to-Date')]: [moment().startOf('quarter'), moment()],
  [t('Year-to-Date')]: [moment().startOf('year'), moment()],
  [t('Yesterday')]: [
