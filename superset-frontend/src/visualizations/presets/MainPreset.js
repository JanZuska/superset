...
import { PluginChartVilgainPivotTable } from '@superset-ui/plugin-chart-vilgain-pivot-table';
  ...
  constructor() {
    ...
    super({
      ...
      plugins: [
        ...
        new PluginChartVilgainPivotTable().configure({ key: 'vilgain_pivot_table' }),
        ...experimentalPlugins,
      ],
    });
  }
